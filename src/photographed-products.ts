...
const createCustomCooler = (slug:string, enColor:string, zhColor:string, esColor:string, image:string, gallery:string[]=[]):Bag => ({
  ...
  seoTitle:t(`${enColor} Bakery Cooler Bags | YUANEN`,`${zhColor}烘焙保温包・手提拉链款 | 远恩`,`Bolsas térmicas ${esColor} para pastelería | YUANEN`),
  short:t(`${enColor} bakery cooler bags`,`${zhColor}烘焙保温包`,`Bolsas térmicas ${esColor} para pastelería`),
...
export const additionalInsulatedBags:Bag[] = [
  ...
  createCustomCooler('red-insulated-cooler-bags','Red','红色','rojo','red-insulated-cooler-bag',['red-insulated-cooler-bag-meal','red-insulated-cooler-bag-bakery','red-insulated-cooler-bag-fresh-food','red-insulated-cooler-bag-drinks']),
