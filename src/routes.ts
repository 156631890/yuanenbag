...
export const pages: Page[] = [
  {path:'/',type:'home',title:tx('Insulated Bag Manufacturer & Custom Packaging | YUANEN','远恩工艺品 | 保温袋生产厂家与定制包装'),description:tx('YUANEN insulated packaging manufacturer: explore our 2026 bag and ice-pack collection, 22 custom ranges and 28,800 m² factory network. Prepare a project enquiry.','远恩保温包装制造商，三地合计 28,800㎡。探索 2026 保温袋与冰袋目录、22 个定制系列、产品图集及采购规格。','Fabricante de embalaje térmico YUANEN: colección 2026 de bolsas y acumuladores de frío, 22 gamas e instalaciones de 28.800 m² en China.')},
